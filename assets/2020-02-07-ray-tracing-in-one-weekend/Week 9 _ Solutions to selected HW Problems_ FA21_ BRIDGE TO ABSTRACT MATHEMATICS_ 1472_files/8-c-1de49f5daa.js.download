(window["canvasWebpackJsonp"]=window["canvasWebpackJsonp"]||[]).push([[8],{"97gy":function(e,r,t){"use strict"
...
var c=t.n(d)
var l=t("hPGw")
var u=c.a.createElement("path",{d:"M1743.8579 267.012456L710.746654 1300.1237 176.005086 765.382131 0 941.387217 710.746654 1652.25843 1919.98754 443.142104z",fillRule:"evenodd",stroke:"none",strokeWidth:"1"})
var _=function(e){Object(i["a"])(t,e)
var r=Object(s["a"])(t)
function t(){Object(a["a"])(this,t)
return r.apply(this,arguments)}Object(o["a"])(t,[{key:"render",value:function(){return c.a.createElement(l["a"],Object.assign({},this.props,{name:"IconCheckMark",viewBox:"0 0 1920 1920"}),u)}}])
t.displayName="IconCheckMarkSolid"
return t}(d["Component"])
_.glyphName="check-mark"
_.variant="Solid"
_.propTypes=Object(n["a"])({},l["a"].propTypes)},HVsT:function(e,r,t){"use strict"
t.d(r,"a",(function(){return _}))
var n=t("VTBJ")
var a=t("1OyB")
var o=t("vuIU")
...
var r=Object(s["a"])(t)
function t(){Object(a["a"])(this,t)
return r.apply(this,arguments)}Object(o["a"])(t,[{key:"render",value:function(){return c.a.createElement(l["a"],Object.assign({},this.props,{name:"IconNo",viewBox:"0 0 1920 1920"}),u)}}])
t.displayName="IconNoSolid"
return t}(d["Component"])
_.glyphName="no"
_.variant="Solid"
_.propTypes=Object(n["a"])({},l["a"].propTypes)},"L+/K":function(e,r,t){"use strict"
t.d(r,"a",(function(){return U}))
var n=t("1OyB")
var a=t("vuIU")
var o=t("Ji7U")
var i=t("LK+K")
...
return r.apply(this,arguments)}Object(a["a"])(t,[{key:"render",value:function(){return d.a.createElement(O["a"],Object.assign({},this.props,{name:"IconInfoBorderless",viewBox:"0 0 1920 1920"}),B)}}])
t.displayName="IconInfoBorderlessSolid"
return t}(s["Component"])
j.glyphName="info-borderless"
j.variant="Solid"
j.propTypes=Object(w["a"])({},O["a"].propTypes)
var I=t("97gy")
...
var U=(x=Object(b["a"])("8.0.0",{closeButtonLabel:"renderCloseButtonLabel"}),z=Object(D["l"])(S,M),x(N=z(N=(E=T=function(e){Object(o["a"])(t,e)
var r=Object(i["a"])(t)
function t(e){var a
Object(n["a"])(this,t)
a=r.call(this,e)
...
a.state={open:true}
return a}Object(a["a"])(t,[{key:"variantUI",value:function(){return{error:{Icon:C["a"],classNames:h()(M.alert,M.error)},info:{Icon:j,classNames:h()(M.alert,M.info)},success:{Icon:I["a"],classNames:h()(M.alert,M.success)},warning:{Icon:L,classNames:h()(M.alert,M.warning)}}[this.props.variant]}},{key:"clearTimeouts",value:function(){this._timeouts.forEach((function(e){return clearTimeout(e)}))
...
if(e){this.srid=Object(R["a"])("Alert")
...
return d.a.createElement("div",{className:M.icon},d.a.createElement(r,{className:M.alertIcon}))}},{key:"renderCloseButton",value:function(){var e=this.props.renderCloseButtonLabel&&Object(g["a"])(this.props.renderCloseButtonLabel)||this.props.closeButtonLabel
return e?d.a.createElement("div",{className:M.closeButton,key:"closeButton"},d.a.createElement(k["a"],{onClick:this.close,size:"small",screenReaderLabel:e})):null}},{key:"renderAlert",value:function(){var e=this.variantUI(),r=e.classNames
return d.a.createElement(f["a"],{as:"div",margin:this.props.margin,className:r,onKeyUp:this.handleKeyUp},this.renderIcon(),d.a.createElement("div",{className:M.content},this.props.children),this.renderCloseButton())}},{key:"render",value:function(){if(this.props.screenReaderOnly){this.getLiveRegion()
return null}if("none"===this.props.transition)return this.state.open?this.renderAlert():null
return d.a.createElement(A["a"],{type:this.props.transition,transitionOnMount:true,in:this.state.open,unmountOnExit:true,onExited:this.onExitTransition},this.renderAlert())}}])
t.displayName="Alert"
return t}(s["Component"]),T.propTypes={children:_.a.node,variant:_.a.oneOf(["info","success","warning","error"]),margin:D["c"].spacing,liveRegion:_.a.func,liveRegionPoliteness:_.a.oneOf(["polite","assertive"]),isLiveRegionAtomic:_.a.bool,screenReaderOnly:_.a.bool,timeout:_.a.number,renderCloseButtonLabel:_.a.oneOfType([_.a.func,_.a.node]),closeButtonLabel:_.a.string,onDismiss:_.a.func,transition:_.a.oneOf(["none","fade"]),open:_.a.bool},T.defaultProps={variant:"info",margin:"x-small 0",timeout:0,transition:"fade",open:true,screenReaderOnly:false,liveRegionPoliteness:"assertive",isLiveRegionAtomic:false,onDismiss:void 0,liveRegion:void 0,renderCloseButtonLabel:void 0,closeButtonLabel:void 0,children:null},E))||N)||N)},uloQ:function(e,r,t){"use strict"
...
//# sourceMappingURL=8-c-1de49f5daa.js.map